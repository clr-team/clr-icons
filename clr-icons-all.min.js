...
/*!********************************************************!*\
  ...
  \********************************************************/
/*! no static exports found */function(l,a,i){"use strict";Object.defineProperty(a,"__esModule",{value:!0}),function(l){l.changeHandlerCallbacks={};var a=function(){function a(){this.callbacks=l.changeHandlerCallbacks}return a.prototype.subscribeTo=function(l,a){var i=this;return this.callbacks[l]?-1===this.callbacks[l].indexOf(a)&&this.callbacks[l].push(a):this.callbacks[l]=[a],function(){var c=i.callbacks[l].indexOf(a);i.callbacks[l].splice(c,1),0===i.callbacks[l].length&&delete i.callbacks[l]}},a.prototype.emitChanges=function(l,a){this.callbacks[l]&&this.callbacks[l].map(function(l){l(a)})},a}();l.instance=new a}(a.ShapeTemplateObserverModule||(a.ShapeTemplateObserverModule={}))},"./src/clr-icons/utils/svg-tag-generator.ts":
/*!**************************************************!*\
