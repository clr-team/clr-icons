...
/***/ "./src/clr-icons/api-autoload.umd.ts":
/*!*******************************************!*\
  !*** ./src/clr-icons/api-autoload.umd.ts ***!
  \*******************************************/
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var api_1 = __webpack_require__(/*! ./api */ "./src/clr-icons/api.ts");
/* tslint:disable:variable-name */
var ClarityIcons = api_1.ApiModule.instance;
ClarityIcons.init();
...
var element_1 = __webpack_require__(/*! ./element */ "./src/clr-icons/element.ts");
    ...
    var ClarityIconsApi = /** @class */ (function () {
        ...
        ClarityIconsApi.prototype.setIconTemplate = function (shapeName, shapeTemplate) {
            ...
            if (this.validateName(shapeName)) {
                ...
                shape_template_observer_1.ShapeTemplateObserverModule.instance.emitChanges(shapeName, trimmedShapeTemplate);
            }
        };
        ...
        ClarityIconsApi.prototype.init = function (icons) {
            ...
            if (typeof window !== 'undefined') {
                if (window && !window.hasOwnProperty('ClarityIcons')) {
                    ...
                    customElements.define('clr-icon', element_1.ElementModule.ClarityIconElement);
                }
            }
            if (icons) {
...
(function (ElementModule) {
    ...
    ClarityIconElement.prototype.connectedCallback = function () {
        ...
        if (this.hasAttribute('shape')) {
            ...
            this._shapeTemplateSubscription = shape_template_observer_1.ShapeTemplateObserverModule.instance.subscribeTo(shapeAttrValue, function (updatedTemplate) {
                _this._injectTemplate(updatedTemplate);
            });
            this.currentShapeAttrVal = shapeAttrValue;
            if (api_1.ApiModule.instance.has(this.currentShapeAttrVal)) {
                var currentShapeTemplate = api_1.ApiModule.instance.get(this.currentShapeAttrVal);
    ...
    ClarityIconElement.prototype.attributeChangedCallback = function (attributeName, oldValue, newValue) {
        ...
        if (attributeName === 'shape') {
            ...
            if (this._shapeTemplateSubscription) {
                ...
                this._shapeTemplateSubscription = shape_template_observer_1.ShapeTemplateObserverModule.instance.subscribeTo(this.currentShapeAttrVal, function (updatedTemplate) {
                    _this._injectTemplate(updatedTemplate);
                });
            }
            if (api_1.ApiModule.instance.has(this.currentShapeAttrVal)) {
                this.currentShapeTemplate = api_1.ApiModule.instance.get(this.currentShapeAttrVal);
            }
            else {
                this._injectErrorTemplate();
                return;
    ...
    ClarityIconElement.prototype._injectErrorTemplate = function () {
        this.currentShapeTemplate = api_1.ApiModule.instance.get('error');
        this._injectTemplate();
    };
})(ElementModule = exports.ElementModule || (exports.ElementModule = {}));
...
Object.defineProperty(exports, "__esModule", { value: true });
/* tslint:disable:no-namespace */
var ShapeTemplateObserverModule;
...
})(ShapeTemplateObserverModule = exports.ShapeTemplateObserverModule || (exports.ShapeTemplateObserverModule = {}));
...
//# sourceMappingURL=clr-icons.js.map